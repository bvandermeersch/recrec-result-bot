...
def recrecbot(event, context):
    ...
    # set season id - eventually read seasons from db and loop them to account for multi leagues      
    season_id = "Av6C8p"
    ...
    for d in data:
        ...
        if match_exists == 0:
            ...
            if d['away_score'] == None and d['home_score'] == None:
                ...
                # send it, to slack and discord
                helpers.discord(group,result,group_id)
                helpers.slack(group,result,group_id)